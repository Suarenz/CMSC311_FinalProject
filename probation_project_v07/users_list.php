                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <a href="add_admin.php" class="btn btn-inverse-success btn-fw">
                                    ...
                                    <table class="table table-hover table-bordered">
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-center"> Name<a href="users_list.php?sort=name"><i class="mdi mdi-sort-alphabetical"></i></a> </th>
                                                ...
                                                <?php endif; ?>
                                                <th scope="col" class="text-center">Registration Date<a href="users_list.php?=sort=rd"><i class="mdi mdi-sort"></i></a></th>
                                ...
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        if ($pages > 1) :
                                            ...
                                            if ($current_page != 1) :
                                        ?>
                                                <li class="page-item"><a class="page-link" href="users_list.php?s=<?= ($start - $display) ?>&p=<?= $pages ?>&sort=<?= $sort ?>">Previous</a></li>
                                            <?php endif; ?>

                                            <!-- Make all the numbered pages: -->
                                            <?php for ($i = 1; $i <= $pages; $i++) : ?>
                                                <li class="page-item <?= ($i == $current_page) ? 'active" aria-current="page">' : '">' ?>
                                                            <a class=" page-link" href="users_list.php?s=<?= (($display * ($i - 1))) ?>&p=<?= $pages ?>&sort=<?= $sort ?>"><?= $i ?></a>
                                                </li>
                                            <?php endfor; ?>

                                            <!-- If it's not the last page, make a Next button: -->
                                            <?php if ($current_page != $pages) : ?>
                                                <li class="page-item"><a class="page-link" href="users_list.php?s=<?= ($start + $display) ?>&p=<?= $pages ?>&sort=<?= $sort ?>">Next</a></li>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </ul>
                                </nav>
