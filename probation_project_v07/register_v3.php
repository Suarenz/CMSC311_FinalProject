...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
	...
	if ($fn && $ln && $e && $p && $mobile_number) { // If everything's OK...
		...
		if (mysqli_num_rows($r) == 0) { // Available.
			...
			$q = "INSERT INTO users (email, pass, first_name, middle_name, last_name, suffix, mobile_number, active, registration_date) VALUES ('$e', '$p', '$fn', '$mn', '$ln', ";
			if ($suffix === null) {
				$q .= "NULL";
			} else {
				$q .= "'$suffix'";
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
				...
				$activationLink = BASE_URL . 'activate.php?x=' . urlencode($e) . "&y=$a";
