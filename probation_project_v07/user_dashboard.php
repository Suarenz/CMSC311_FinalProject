                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="search_query" name="search_query" placeholder="Search Here..." required>
                                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <blockquote class="blockquote blockquote-danger">
                                            <h6 class="text-danger font-weight-bold">If you cannot find the name of the Petitioner you are looking for, here are the possible reasons:</h6>
                                            <ul class="text-danger list-arrow">
                                                <li>Case not yet filed: The petition may not have been filed yet, or it might be in the process of being filed and hasn't been entered into the system. In such cases, the user would need to wait until the case is officially filed and processed before it becomes searchable.</li>
                                                <li>Incomplete or inaccurate search criteria: You may not be providing enough or accurate information to narrow down the search results.</li>
                                                <li>Case filed under a different name: The petitioner might have filed the case under a different name, such as their married name, nickname, or alias. If you are unaware of these alternative names, you may not be able to find the petitioner's record using their primary name alone.</li>
                                                <li>Technical issues: Technical glitches or downtime on the search platform could temporarily prevent the user from accessing or retrieving petitioner information.</li>
                                            </ul>
                                        </blockquote>
                                    </div>
                                </div>
