...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($e && $p) { // If everything's OK.
        ...
        // Query the database:
        $q = "SELECT user_id, first_name, last_name, user_level, pass, role FROM users WHERE email='$e' AND active IS NOT NULL";
                        ...
                        <form action="login.php" method="post">
                            ...
                            <div class="form-group txt_field">
                                ...
                                <div class="input-group">
                                    <input type="password" name="pass" class="form-control" id="password" autocomplete="current-password"
                                        value="<?php if (isset($_POST['pass'])) echo htmlspecialchars($_POST['pass'], ENT_QUOTES); ?>">
