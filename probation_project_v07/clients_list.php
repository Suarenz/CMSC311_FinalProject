...
$query = "SELECT *, DATE_FORMAT(registration_date, '%b. %d, %Y') AS dr, id FROM clients WHERE archived_status IS NULL ORDER BY $order_by LIMIT $start, $display";
                                                    ...
                                                    <td>
                                                        <div class='dropdown'>
                                                            ...
                                                            <div class='dropdown-menu dropdown-menu-right' aria-labelledby='dropdownMenuButton1'>
                                                                ...
                                                                <a class='dropdown-item text-dark' href='client_archive.php?id=<?= $row['id'] ?>' onclick="return confirm('Are you sure you want to archive this client?');">Archive</a>
