...
// $pdo = new PDO('mysql:host=localhost;dbname=probasyon', 'root', '');


// SMS API TOKEN FOR Twilio
define('ACC_SID', 'AC4a5f53fb793e4141e19456b0307e2bbf');
define('AUTH_TOKEN', '1622ae2043bca9214a9ccee11f44e47b');


try {
  $dsn = "mysql:host=localhost;dbname=probasyon;charset=utf8";
  $username = "root";
  $password = "";
