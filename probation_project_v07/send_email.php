...
function send_email($recipientEmail, $subject, $body) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'navajajhonmanuel@gmail.com'; // Your email address
        $mail->Password   = 'sscw lzzp pwdf droi'; // Your email password or app-specific password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS; // Enable TLS encryption
        // $mail->SMTPSecure = 'ssl'; // Enable TLS encryption
        $mail->Port       = 587; // TCP port to connect to
    
        // Sender
        $mail->setFrom('navajajhonmanuel@gmail.com', 'Administrator');
